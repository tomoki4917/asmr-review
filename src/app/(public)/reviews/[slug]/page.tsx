...
export default async function ReviewPage({ params }: Props) {
  ...
  > = {
    ...
    "mesugaki-succubus-onee-nntr-saimin": {
      ...
      workImpressionParagraphs: [
        "「メスガキサキュバスのおねえちゃんの彼氏寝取り催眠」は、非常にユニークなコンセプトが印象的な作品です。リスナーの抵抗心を快感へと転換させるマゾヒスティックなアプローチが特徴で、物語性豊かなロールプレイを通じて、罪悪感や羞恥心を刺激しながら脳イキやドライオーガズムへと誘います。導入から解除まで一貫した快感設計がされており、コンセプトがしっかりと回収されている点に満足感を覚えました。",
        "この作品は、単なる快感だけでなく、物語性やロールプレイの世界観に深く浸りたい方におすすめできます。特に、マゾヒスティックな快感や、罪悪感を伴う背徳的な体験に魅力を感じる方には、独特の後味を楽しんでいただけるでしょう。ただし、トランス深度は控えめなため、音響的な没入感よりも、言語による暗示とコンセプトの面白さを重視する方に特に向いていると感じました。",
      ],
      workImpressionParagraphs: [
        "本作は、メスガキサキュバスによる彼氏寝取りという背徳的なテーマを、見事に快感へと昇華させた作品だと感じました。リスナーの「抵抗」や「罪悪感」を快感に変換する独自のロジックが非常に巧みで、脳イキ型やドライオーガズム型の快感を深く追求しています。特に、物語性とキャラクターの魅力が、この特殊な体験をより一層引き立てるため、背徳感のあるシチュエーションが好きな方には強くおすすめできます。",
        "約109分という長尺ながら、物語のすべてのパートがラストのクライマックスへと緻密に繋がっていく構成は見事です。言語暗示を中心に、リスナーの感情や認知に働きかける誘導は、音響的な裏付けが控えめな分、より物語への没入感を高めます。トランスの深度は穏やかですが、コンセプトの回収と解除パートの充実度が高く、聴き終えた後の満足感は非常に高い水準にあると感じました。",
      ],
      workImpressionParagraphs: [
