...
export default async function ReviewPage({ params }: Props) {
  ...
  > = {
    ...
    "hypno-cloud": {
      scoreLabel: "8.0 / 10",
      oneLine:
        "約46分16秒（短尺寄りの通し尺）。手を引くジャーニーで視界を奪い、雲の濃度とカウント増幅で性感を段階的に積むバイノーラル催眠（エロトランス／ヒプノクラウド）",
      ...
      recommendedFor: [
        "囁き定位と物語として連れていかれる体験を重ねたい方",
        "視界喪失とジャーニー深化を通しで味わいたい方",
        "雲の段階とカウント増幅で快感を波状に積みたい方",
      ],
      notRecommendedFor: [
        "導入・誘導を削ってエロ帯だけを即食いしたい方",
        "イヤホン前提が現実的でない方",
      ],
    },
    "hypno-multi-rape": {
