  ...
  > = {
    ...
    "spy-jinrui-saimin-doreika-kousaku": {
      ...
      workImpressionParagraphs: [
        ...
        "物語性のある催眠をじっくりと味わいたい方や、脳イキを求める方には、特に向く作品だと感じます。丁寧な解除パートが用意されているため、深い催眠体験から現実へ安全に戻れる安心感も大きかったです。スパイによる奴隷化工作という設定を、長尺で堪能できる一本でした。",
      ],
    },
    ...
    "sound-of-ecstasy-saimin": {
      ...
      workImpressionParagraphs: [
        "左右から話しかける二つの声が、最初から意識の置き場所を左右に分けていきます。リラックス運動で身体を動かしながら音だけを追う時間が長く、いつもより素直に受け入れられる導入だと感じました。",
        "本編では「快楽の光」が神経を走り、音が増えるたびに快感が弾ける流れが続きます。パチッと意識が暗くなる合図のあと、焦らしを経て連続ドライ絶頂へ一気に押し上げられる波が、この作品らしい強さです。",
        "解除では光が体から抜け、カウントで目覚めるまで余韻を残しつつ現実へ戻れます。強い本編のあとでも慌ただしく切れず、安心して終えられる着地が心地よかったです。",
        "音楽と声で意識を預け、壊れるほどの快感まで追い込みたい方に向く一本です。左右から挟まれる定位や連続ドライ絶頂を味わいたい方におすすめします。",
      ],
    },
    ...
    "haraguro-seiso-joou-uraomote-sasayaki": {
      ...
      workImpressionParagraphs: [
        "「ご指名ありがとうございます」と丁寧に挨拶した直後、心の声だけが「落とすの簡単そう」と漏れる——この落差が、腹黒清楚編の入口です。マッサージの間合いは柔らかいのに、本音はずっと支配側。表の演技を聴きながら裏の意図が読めるので、背徳感はかなり濃いです。",
        "二本目は口調こそ冷たいですが、心の声では「言葉が出てこない」「本当はこんな感じでやってもらいたい」と戸惑いが混ざります。初めてSを務めるぎこちなさが、言葉責めの強さと逆方向に働くので、腹黒編とは味わい方が変わります。",
        "トランスの深さだけを追うと物足りないです。誘導は雰囲気寄りで、本編の大半は乳首刺激と寸止め・M向けの支配の語りです。二本立てで声も役も切り替わるので、連続ドラマより「表と裏を味わうセット」として聴いた方が噛み合います。",
        "表裏の落差とM快感ははっきり届く一方、催眠専売の深いトランスや穏やかな着地を最優先にする人には伸びしろが残る印象です。心の声が聞こえる設定と乳首開発が好きなら試す価値はありますが、カウント深化一本の深さを期待するなら別の一本の方が合いやすいです。",
      ],
    },
    ...
    "saimin-asmr-daraku-no-match": {
      ...
      workImpressionParagraphs: [
        "再会したマッチ売りの少女・香織が、手へのお香と拘束で儀式を始める場面から物語が動き出します。擦れるマッチの音と甘い香りが耳元に届くたび、部屋の空気が非日常へ切り替わっていく感覚がありました。前作の余韻を知っているほど、関係が一歩進んだ再会の体温が伝わってきます。",
        "意識の炎を息で消すカウント深化と、練香を練る時間は、嗅覚のイメージごと深く落としていきます。後半はマッチ音より「好き」の言葉が快感のトリガーになる比重が高まり、前作ほどマッチ一本に寄せた体験ではなくなります。意地悪に好意を一度引いてから返す駆け引いは、胸が満たされる報酬感が強く残りました。",
        "アダルトパートではカウント絶頂で脳内快感を回収し、試作品マッチと耳責めで堕落の快感へ進みます。本番描写はあるものの挿入音は控えめで、想像で補う部分もあります。解除は赤いマッチで覚醒させつつ、依存の言葉を残す着地なので、甘い余韻と次への期待が同居した後味でした。",
        "前作『蠱惑のマッチ』を聴いたうえで、Sっ気と純愛の進展を味わいたい方に向く一本です。マッチの音だけで深く落ちたい方や、催眠に極振りの重厚導入を求める方には、導入の軽さやテーマの重心移りが合わないかもしれません。",
      ],
    },
    "saimin-asmr-noushin-slime": {
      ...
      recommendedLevel:
        "初級トランス（重感・深い脱力まで導入できる）以上の方",
      recording:
        "本編約55分54秒（注意1:48＋解除2:24＋安眠版16:12／バイノーラル）",
      recommendedFor: [
      ...
      workImpressionParagraphs: [
        "「快感でドロドロに溶かして頭の中ぐちぐちに」と最初に約束される通り、本作は耳の奥から頭内へ入り込む液体のイメージが主役です。にゅるにゅるの音が左右から追いかけてくるうち、呼吸のペースだけが先に整い、批判的な思考が薄れていく手触りがはっきりしました。",
        "「頭の中を書き換えられちゃったんだからそうなってしまうのは当たり前」に近い温度感の台詞のあと、理性より快感が優先される流れに意識が引きずられます。頭の奥のしびれとビリビリが重なる段落では、下半身より先に頭側が飽和する脳イキの輪郭がくっきり出てきました。",
        "絶頂の往復と再深化のあと、三拍カウントと伸びで現実へ戻す解除は流れとして丁寧でした。解除の導入は「耳かきしてたら寝落ちしたんだよ」という流れから始まりますが、「ん？急に耳かき？」と一瞬思いました。ドライ直後なので、タイミングとしてはそれほど浮きはしないと感じます。",
        "深いトランスと脳内快感を優先する人には刺さる一本です。物語の説明まで本編と同じ温度で一本に回収したい人には、説明のトーンだけは好みが分かれるかもしれません。",
      ],
    },
