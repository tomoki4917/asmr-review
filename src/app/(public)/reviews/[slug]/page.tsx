...
export default async function ReviewPage({ params }: Props) {
  ...
  > = {
    ...
    "ts-nyotaika-saimin-ntr-shojo-dry-orgasm": {
      ...
      workImpressionParagraphs: [
        "「キスしかしていない恋人の前で」という設定に惹かれて聴き始めたのですが、導入の穏やかな語りかけからは想像できないくらい、一気に背徳側へ振り切る作品でした。純愛の空気をわざと作っておいて、彼氏の友人の乱入から輪姦まで転がり落ちていく落差は、正直シチュとしてかなり強い。個人的には、この最初の掴みで「うわ、そう来るのか」と一気に引き込まれました。ここで乗れるかどうかで評価が真っ二つに分かれる気がします。",
        "ただ、催眠音声として深いトランスを味わいたい私としては、少し物足りなさも残りました。導入と暗示パートのリラックス誘導や100カウントは丁寧なのに、本編に入ると誘導そのものより媚薬と状況の生々しさが主役になっていく。「もうやめて…」と言いながら身体が言うことを聞かない描写は確かに生々しいのですが、催眠で落とされているというより、シチュに興奮させられている感覚のほうが近かったです。トランス目当てだと肩透かしかもしれません。",
        "その代わり、快楽の手数はとにかく多い。クリトリスへの執拗な責めから潮吹き、処女喪失、中出しと、ウェットな絶頂が途切れずに畳みかけてきます。TS女体化して女の子の身体で犯される、という体験そのものに没入できる人ほど刺さるはず。声優陣が冷たさと甘さを行き来しながら煽ってくるのが上手くて、理性をじわじわ溶かしにくる感じは私も素直に良かったところです。",
        "正直、解除後にあっさり「親友になった」と結ばれる後味にはちょっと冷めてしまったので、純愛の余韻や物語のきれいな着地を期待する人にはおすすめしにくいです。でも、TS女体化・NTR・輪姦の背徳感を浴びたい人には、催眠の深さではなく“シチュの強さ”で選ぶ一本として十分アリだと思います。理屈を置いて快楽に身を委ねたい夜に、割り切って聴くと気持ちいいタイプの作品でした。",
      ],
    },
