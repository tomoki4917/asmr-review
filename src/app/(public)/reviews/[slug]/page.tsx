...
export default async function ReviewPage({ params }: Props) {
  ...
  > = {
    ...
    "unknown-hypno-daijobu-koe-ni-yudanete": {
      scoreLabel: "10.0 / 10",
      oneLine:
        "「あなたの無意識」として語り手が一体化し、往復深化と扉暗示で最深部まで落としたあと、心→頭→全身のドライ絶頂波を長尺で積み上げる深催眠",
      inductionType: "無意識同一化系 / 往復深化系 / 現実混線系",
      voiceActor: "天知遥",
      majorFetish: "一体感 / 往復深化 / 脳イキ / 全身絶頂 / 安眠分岐",
      kinkType: "ノーマル〜M向け",
      recommendedLevel:
        "中級トランス（暗示を受け入れられる・絶頂反応は未達）以上の方",
      recording: "約1時間49分46秒（注意〜覚醒／バイノーラル本編）",
      recommendedFor: [
        "往復深化で底まで落ちたい方",
        "「私はあなたの無意識」という同一化語りが刺さる方",
        "安眠分岐と性感本線を使い分けて聴きたい方",
      ],
      notRecommendedFor: [
        "短時間で即刺激だけを求める方",
        "射精・喘ぎ中心の物理刺激を重視する方",
      ...
      workImpressionParagraphs: [
        "サークル「エロトランス」の催眠音声で、天知遥さんが語り手を担当しています。聴き終わった印象としては、語り手が「あなたの無意識」として現れる一体化と、往復深化・扉暗示で底まで落ち続ける流れがとても追いやすく、深度の深さが際立つ作品だと感じました。暗示を受け入れられる中級トランス以上の方には、特におすすめできます。",
        "本作は、心の幸福から脳イキ、全身絶頂へと段階的に広がる快感波を、言葉と暗示だけで描き切る構成が特徴です。射精や喘ぎに頼らない脳イキ型として、トランスの中で快感が重なる感覚は、頭の中だけで絶頂を追いたい方にぴったりでしょう。一体感を重視する方にも強く響く一本だと思います。",
        "語り手が聞き手の無意識として語りかける設定に抵抗がある方には、合わない可能性があります。約110分と長尺なので、一気通貫より安眠分岐も含めて聴き分けたい方に向いていると思います。",
        "覚醒で荒波をさざ波に収束させる締めまで整っており、満たされた余韻のまま戻れる一本です。",
      ],
    },
    ...
    "sukisuki-surikomi-chudoku-onanie-saimin": {
      ...
      workImpressionParagraphs: [
        "サークルSi-Aの御子柴泉さんが演じる冬木咲良による、ヘミシンク付きの条件付けオナニー催眠です。聴き終わった印象としては、呼吸・脱力から深化、好き好きオナニー絶頂まで段階がはっきりしていて、刷り込みの追いやすさが際立つ一本だと感じました。",
        "本作は、「好き」と名前呼称を交互に重ねながら握力や速度を命令で切り替える流れが特徴です。焦らしのあと合図でウェットに一回収束する着地も明快で、条件付けとオナニー指示を楽しみたい方には、ぴったりでしょう。",
        "解除で数え上げから現実へ戻しつつ、暗示を奥に残す締めまで整っています。人形化や支配のテーマに抵抗がなければ、長く没入して聴き終わっても戻りやすい一本だと私は思います。",
      ],
    },
    ...
    "usotsuki-kouhai-suki-suki-seishin-shihai": {
      scoreLabel: "10.0 / 10",
      oneLine:
        "演劇部後輩の演技好きで脱力と恋心を固定し、嘘告白の脳イキ連鎖・寸止め自動手コキのあと嘘→本当反転でカウント射精まで追い込む長尺M精神支配催眠",
      ...
      workImpressionParagraphs: [
        "サークルF・A・Sの陽向葵ゅかさんが演じる演劇部後輩による、好き刷り込みM精神支配催眠です。聴き終わった印象としては、レクリで音へ寄せたあとドラマで嘘の好きという前提が置かれ、本編では好き連呼だけで脱力と脳イキが連鎖していく追いやすさが際立つ一本だと感じました。",
        "本作は、多口調の演技告白と嘘弄りの反転、自動手コキ寸止めからカウント射精まで一続きで回収する流れが特徴です。悔しさと快感が同時に来るM向けの落差が好きな方には、ぴったりでしょう。",
        "解除でも嘘と本当の境界を曖昧に残す締めまで整っています。初回はレクリとドラマを聴いてから本編へ入る想定ですが、長尺でも戻りやすい余韻があるので、好き攻撃系をじっくり楽しみたい方におすすめできます。",
      ],
    },
    "nisemono-genjitsu-anji": {
      scoreLabel: "9 / 10",
      oneLine:
        "管理AIの逆進行解除で仮想と現実がリンクし、解放トリガーと触手多峰のあと家畜化反転まで追い込む、長尺の破滅願望系精神支配催眠",
      ...
      workImpressionParagraphs: [
        "「ニセモノの現実暗示」は、管理AIが解除手順を逆に進めながら仮想と現実を混線させる、約2時間の精神支配催眠です。聴いているうちにどちらが本物か判別しづらくなる手触りが、この作品の芯にあります。",
        "快感の要は「解放」という合図です。約45分付近から触手やガスの感覚が強まり、興奮禁止のあとカウント絶頂から家畜化反転、最終射精まで落差が大きいです。",
        "逆催眠と触手搾取に耐性があり、M向けの長尺を一気に聴ける方に向いています。裏切り選択で家畜化へ反転する結末の落差が、本作の見どころです。",
      ],
    },
    "unreal-hypno": {
      scoreLabel: "9.0 / 10",
