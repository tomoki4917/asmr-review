...
export const quickGuideBySlug: Record<string, QuickGuideSpec> = {
    ...
    "tenshi-succubus-vtuber-trance-haishin": {
      scoreLabel: "8.0 / 10",
      oneLine:
        "配信形式のサキュバスVtuberが多層深化で深く落とし、許しますトリガーで幸せ絶頂→支配下オナサポへつなぐ長尺催眠",
      inductionType: "深化誘導系 / カウント誘導系 / 支配暗示系",
      voiceActor: "桃瀬める",
      majorFetish: "サキュバス / Vtuber / 信者化 / 支配 / オナサポ",
      kinkType: "M向け",
      recommendedLevel:
        "中級トランス（暗示を受け入れられる・絶頂反応は未達）以上の方",
      recording: "本編約96分（Tr1注意事項〜Tr4解除）",
      recommendedFor: [
        "多層的な深化誘導で深く落ちたい方",
        "サキュバスによる支配と堕落を求める方",
      ...
      workImpressionParagraphs: [
        "サークル様1本目の催眠音声で、withnyというサイトで活動している実在するVtuberさんが代表・声優を務めています。この作品の特徴は丁寧な誘導と【ある言葉】をトリガーにした圧倒的な多幸感的絶頂にあります。",
        "誘導は呼吸誘導と雲を用いたイメージ誘導で、リスナーの筋肉や意識を緩めていくわけですが、個人的にはパターンが少ない割に誘導が長く、集中が途切れてしまう場面もありました。ここは好みかなと思います。ですが、呼吸誘導法は一番簡単に催眠体験を得られる手法でもあるので、初心者さんが催眠というものを体験してみたい！！という意図の元購入するのはありだと思います。",
        "快楽パートですが、言葉をトリガーにした連続多幸絶頂です。私は主に頭が主で股間も少し気持ちよかったかなという印象。正直これは慣れもいるかなと思いました。相性がベストマッチしたら連続絶頂できるかなという評価です。セルフもありますので全体的には満足度の高い丁寧な作品に仕上がってると思います。",
        "この作品で【桃瀬める】さんが気になった方はこちらで配信活動を行っているみたいなのでチェックしてみてください。https://www.withny.fun/channels/Momosemeru",
      ],
    },
    "zeccho-chudan-saimin-ninjutsu-mesuiki": {
      scoreLabel: "9.0 / 10",
      oneLine:
        "くノ一に捕まり絶頂を3秒だけ許されては封じられる、絶頂中断で快感を溜め続けるドライ志向の催眠拷問",
      inductionType: "カウント誘導系 / 支配暗示系 / イメージ誘導系",
      voiceActor: "架月らみゅ",
      majorFetish: "絶頂中断 / ドライオーガズム / メスイキ / メス堕ち / くノ一",
      kinkType: "M向け",
      recommendedLevel:
        "中級トランス（暗示を受け入れられる・絶頂反応は未達）以上の方",
      recording: "本編約1時間（導入〜解除）",
      recommendedFor: [
        "絶頂中断で快感を溜めたい方",
        "くノ一・支配拷問のシチュが好きな方",
        "ドライオーガズムを深く味わいたい方",
      ...
      notRecommendedFor: [
        "寸止めだけを求める方（本作は中断された絶頂）",
        "ストーリー色の強い催眠が苦手な方",
      ],
      workImpressionParagraphs: [
        "潜入任務の物語から入り、丁寧な催眠誘導のあと、捕縛されてからの絶頂封じが本丸です。3秒だけ絶頂が許されても快感がほとんど抜けず、また寸前に戻される感覚が独特で、寸止めとは違う苦しさと気持ちよさが同居していました。",
        "感度を上げられてからの連続中断は、慣れが要るタイプだと感じました。相性が合うとドライの厚みがかなり増す一方、物語パートが長いので、責めだけ欲しい人には前半が冗長に感じるかもしれません。",
        "くノ一同士の力関係と背徳感が好きなら刺さる一本です。催眠そのものは段階が分かりやすく、ドライは開発済みだけど誘導は丁寧めでほしい、という人にも試しやすいはずです。",
      ],
    },
    "chikubi-mesuiki-hypno-trance-genneko": {
      scoreLabel: "9.0 / 10",
      oneLine:
        "長い海底イメージ誘導のあと、乳首への集中刺激でメスイキ方向の絶頂波を重ねるヒプノトランス",
      inductionType: "イメージ誘導系 / カウント誘導系 / 感覚誘導系",
      voiceActor: "玄音仔",
      majorFetish: "乳首 / メスイキ / ヒプノトランス / 射精しない絶頂",
      kinkType: "M向け",
      recommendedLevel:
        "中級トランス（暗示を受け入れられる・絶頂反応は未達）以上の方",
      recording: "本編約90分（注意〜導入〜乳首メスイキ〜解除）＋メッセージ",
      recommendedFor: [
        "乳首でメスイキを狙いたい方",
        "長い深化誘導で深く落ちたい方",
        "射精を超える連続絶頂波を味わいたい方",
      ...
      workImpressionParagraphs: [
        "導入の海〜海底ルートが長く、声に身を任せるまでにかなり時間を使います。そのぶん沈んだあとの快感パートは入りやすく、乳首への描写が始まってからの波の増え方が印象に残りました。",
        "射精しない快感に慣らしてから乳首へ移る段取りは分かりやすいです。数字や段数のたびに絶頂波が戻ってくる感覚は、相性が合うとメスイキ寄りの厚みがかなり出ます。合わないと導入の長さだけが先に来るタイプかもしれません。",
        "玄音仔さんの声は甘めで密着感があり、研究風の世界観とも噛み合っていました。乳首メスイキに興味がある人向けの、丁寧で長い一本だと思います。",
      ],
    },
    "elf-mori-konran-zeccho-shihai-saimin": {
      scoreLabel: "10.0 / 10",
      oneLine:
        "エルフ女王の混乱誘導と秘薬暗示で思考を止め、射精とドライを競らせて堕とす支配催眠",
      inductionType: "コンフュージョン系 / 支配暗示系 / 感覚誘導系",
      voiceActor: "架月らみゅ",
      majorFetish: "エルフ / 混乱誘導 / 支配 / ドライオーガズム / メスイキ",
      kinkType: "M向け",
      recommendedLevel:
        "中級トランス（暗示を受け入れられる・絶頂反応は未達）以上の方",
      recording: "本編約54分（本編・射精vsドライ・添い寝／解除）",
      recommendedFor: [
        "混乱誘導が好きな方",
      ...
      workImpressionParagraphs: [
        "左右から異なる指示が交互に囁かれる「コンフュージョン誘導」を主に用いた1時間未満の高品質な短尺作品です。コンフュージョン誘導のいいところは本当にぼーっと聞いてるだけで催眠状態に入りやすいことですよね。",
        "この作品の特徴は片耳はドライを、もう片耳はウェット指示を、というように両方の絶頂を促してくれます。結果私は頭が気持ちよくなる脳イキに近い感覚を感じながらウェットできました。人によっては同時イキできると思います。",
        "また、快楽の種類も多様で乳首、前立腺、耳舐めによる脳イキを1時間に凝縮し、なおかつそれらが喧嘩しあっていないという素晴らしい脚本です。",
        "約2年前に発売された作品ですが、サークル様の技術基盤がしっかりしているのでこの短時間でも高い満足度の快楽体験を得ることができます。ROI（時間対効果）は恐ろしく高い作品でしたので自信をもって★10をつけさせていただきました。",
      ],
    },
    "mesugaki-mimi-zencho-haiboku-saimin": {
      scoreLabel: "9.0 / 10",
      oneLine:
        "耳を性感帯へ変える暗示と実刺激を重ね、連続ドライから監視下の射精まで敗北させる耳責め催眠",
      inductionType: "逆カウント系 / 反復刷り込み系 / 服従・支配系",
      voiceActor: "架月らみゅ",
      majorFetish:
        "耳かき / 耳舐め / メスガキ / ドライオーガズム / 敗北オナニー",
      kinkType: "M向け",
      recommendedLevel:
        "中級トランス（暗示を受け入れられる・絶頂反応は未達）以上の方",
      recording: "本編約1時間15分9秒（導入・誘導・耳責め・敗北オナニー・解除）",
      recommendedFor: [
        "挑発的なメスガキJ〇に支配されたい方",
      ...
      workImpressionParagraphs: [
        "「先生が私に興奮したら負け」という勝負は、催眠へ入る前から自制心を試してきます。過去の敗北動画まで握られた教師が、放課後の空き教室でまた挑発に乗せられる始まりには、逃げ道のない関係性がよく出ていました。",
        "呼吸と手足の脱力に続いて逆カウントへ入るため、耳かきが始まる時点では身体の力を抜きやすくなっています。耳かきの感触を乳首へ移し、再び耳へ戻す暗示も分かりやすく、耳が快感の入口へ変わる過程を追いやすいと感じました。",
        "耳舐めのあとにローションを使った両耳刺激へ進む場面は、片耳ずつだった快感が左右から押し寄せる変化が効いています。ドライの連続だけで終わらず、最後に自分の手を動かして射精させられることで、先生としての敗北まできちんと形になります。",
        "一方、誘導後は挑発と耳への実刺激が前へ出ます。静かな語りだけで沈み続けたい場合には騒がしく感じられますが、生意気な口調に責められながら耳を開発されたいなら、この強いキャラクター性こそ魅力になります。",
      ],
    },
    "yumesasoi-2nd-nekashitsuke-kofuku": {
      scoreLabel: "9.0 / 10",
      oneLine:
        "眠れない夜を布団の温もりととろける声で受け止め、脳イキから自然な眠りへ渡す寝かしつけ",
      inductionType: "呼吸誘導系 / 感覚誘導系 / カウント誘導系",
      voiceActor: "紫雲",
      majorFetish: "寝かしつけ / 脳イキ / ささやき / 甘やかし",
      kinkType: "M向け",
      recommendedLevel:
        "初級トランス（重感・深い脱力まで導入できる）以上の方",
      recording: "本編約15分（BGMなし／あり）",
      recommendedFor: [
        "やさしい声で寝かしつけられたい方",
        "脳イキの山場もほしい方",
        "支配色の薄い催眠が好きな方",
      ...
      workImpressionParagraphs: [
        "眠れない夜のうずうずを責めない導入がまず心地よかったです。布団とぎゅー、とんとん、呼吸合わせで「声だけに集中して」と預かってもらう感じは、寝かしつけとして自然に入れました。",
        "中盤は脱力と温かさから頭のジュワジュワ／ピリピリへ切り替わり、カウントで弾ける波が数回来ます。射精描写はなく、脳イキ寄り。寝かしつけのなかに山場があるのは助かります。",
        "最後は眠らなくていいと言ってから、とろっと眠気側へ渡す着地でした。優しい催眠と軽い快感が一緒に欲しい夜向きの一本だと思います。",
      ],
    },
  };
